...
//merging block
    ...
    for(a1=0; a1<merge_node; a1++)
    {
        ...
        flag_n1=0;
        if(node_status[a3]==0 && a3<no_of_nodes)
        {
    ...
    for(a9=0; a9<left_over; a9+=2)
    {
        for(a10=0; a10<keys_per_node; a10++)
        {
            a0++;
            merge_key_set[a0][a10][0]=key_set[a9][a10][0];
            merge_key_set[a0][a10][1]=key_set[a9][a10][1];
            node_status[left_over_node_list[a9]]=0;
            merge_key_set[a0][keys_per_node+a10][0]=key_set[a9+1][a10][0];
            merge_key_set[a0][keys_per_node+a10][1]=key_set[a9+1][a10][1];
